...
import { githubRepository, withBase } from "../site-paths";
...
<Section padding="80px 32px" id="async-fetch">
  <div style="text-align:center;margin-bottom:36px;">
    ...
    <p style="font-size:15.5px;line-height:1.6;color:var(--alc-fg-2);max-width:760px;margin:0 auto;">
      Effect is optional. Declare resources, attach them as bindings, and Alchemy infers a fully typed <code class="alc-code-inline">env</code> for your async worker — no codegen, no <code class="alc-code-inline">wrangler types</code>, no manual interfaces. <a class="alc-learn-more" href={withBase("/guides/migrating-from-v1")}>Learn more &rarr;</a>
    </p>
  </div>
...
<Section padding="80px 32px" background="var(--alc-bg-nav)" id="hot-reload">
  <div style="text-align:center;margin-bottom:32px;">
    ...
    <p style="font-size:15.5px;line-height:1.6;color:var(--alc-fg-2);max-width:680px;margin:0 auto;">
      Vite, Astro, TanStack, SolidStart — frontend, backend, and infra hot-reload together against real R2 / KV / D1. <a class="alc-learn-more" href={withBase("/concepts/local-development")}>Learn more &rarr;</a>
    </p>
  </div>
...
<Section padding="80px 32px" id="live-tests">
  <div style="text-align:center;margin-bottom:32px;">
    ...
    <p style="font-size:15.5px;line-height:1.6;color:var(--alc-fg-2);max-width:720px;margin:0 auto;">
      Each suite spins up its own isolated stack — live R2, DynamoDB, Workers — runs your assertions, then tears it back down. No mocks to babysit, no drift between fixture and production. <a class="alc-learn-more" href={withBase("/concepts/testing")}>Learn more &rarr;</a>
    </p>
  </div>
...
<Section padding="80px 32px" background="var(--alc-bg-nav)" id="ci-previews">
  <div style="text-align:center;margin-bottom:32px;">
    ...
    <p style="font-size:15.5px;line-height:1.6;color:var(--alc-fg-2);max-width:720px;margin:0 auto;">
      An Alchemy program is just TypeScript — drop one into GitHub Actions to deploy a per-PR stack for review, then let merge or close tear it down. <a class="alc-learn-more" href={withBase("/guides/ci")}>Learn more &rarr;</a>
    </p>
  </div>
...
<Section padding="80px 32px" id="operational-readiness">
  <div style="text-align:center;margin-bottom:32px;">
    ...
    <p style="font-size:15.5px;line-height:1.6;color:var(--alc-fg-2);max-width:760px;margin:0 auto;">
      Effect emits logs, spans, and metrics by default. Wire dashboards and alarms in the same <code class="alc-code-inline" style="color:var(--alc-accent-deep);">alchemy.run.ts</code> as the workers they watch — swap the OTLP exporter for Axiom, Datadog, or anywhere else. <a class="alc-learn-more" href={withBase("/concepts/observability")}>Learn more &rarr;</a>
    </p>
  </div>
